...
namespace BinaryTrees
{
    public class BinaryTreeNode<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        public int Count()
        {
            ...
            int countDerecha = 0;
            int countIzquierda = 0;
            if (LeftChild != null)
            {
                countIzquierda = LeftChild.Count();
            }
                if (RightChild!= null)
            {
                countDerecha = RightChild.Count();
            }
            return 1+countIzquierda+countDerecha;
        ...
        public int Height()
        {
            ...
            if (LeftChild != null)
            {
                alturaIzquierda = 1 + LeftChild.Height();
            }
            if (RightChild != null)
            {
                alturaDerecha = 1 + RightChild.Height();
            }
            if (alturaIzquierda <= alturaDerecha)
            {
                alturaMax = alturaDerecha;
            }
            else
            {
                alturaMax = alturaIzquierda;
            }
            return alturaMax;
        ...
        BinaryTreeNode<TKey, TValue> nodoActual = this;
        ...
        {
            nodoActual.LeftChild = siguiente.RightChild;
        }
    }
